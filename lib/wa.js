...
exports.sendSticker = (from, filename, sam) => {
        samu330.osendMessage(from, filename, MessageType.sticker, {quoted: sam})
}
...
exports.sendFakeStatus2 = (from, teks) => {
        samu330.osendMessage(from, teks, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": '🔥❣️Sᥲm ყ Pᥱrrყ | NყᥲᥒBot🐬', "jpegThumbnail": fs.readFileSync(`./src/fake.jpg`)} } } })
}
...
exports.FakeTokoForwarded = (from, teks, fake) => {
        ...
        samu330.osendMessage(from, teks, MessageType.text, {quoted: anu, contextInfo: {"forwardingScore": 999, "isForwarded": true}})
}

exports.FakeStatusImgForwarded = (from, image, caption) => {                                                                                                                             samu330.osendMessage(from, image, MessageType.image, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": '📌NyanBot', "jpegThumbnail": fs.readFileSync(`./src/help.jpg`)} } }, caption: caption, contextInfo: {"forwardingScore": 999, "isForwarded": true} })
}

exports.osendMessage = async(from, text) => {
    await samu330.osendMessage(from, text, MessageType.text)
}

exports.sendAudio = async(from, buffer) => {
    await samu330.osendMessage(from, buffer, MessageType.mp4Audio, { mimetype: Mimetype.mp4Audio, ptt: true })
}

exports.sendImage = async(from, buffer, caption = "") => {
    await samu330.osendMessage(from, buffer, MessageType.image, { caption: caption })
}

exports.sendVideo = async(from, buffer, caption = "") => {
    await samu330.osendMessage(from, buffer, MessageType.video, { caption: caption })
}

exports.sendSticker = async(from, buffer) => {
    await samu330.osendMessage(from, buffer, MessageType.sticker)
}

exports.sendPdf = async(from, buffer, title = "Samu330.pdf") => {
    await samu330.osendMessage(from, buffer, MessageType.document, { mimetype: Mimetype.pdf, title: title })
}

exports.sendGif = async(from, buffer) => {
    await samu330.osendMessage(from, buffer, MessageType.video, { mimetype: Mimetype.gif })
}

exports.sendContact = async(from, nomor, nama) => {
    const vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:' + nama + '\n' + 'ORG:Kontak\n' + 'TEL;type=CELL;type=VOICE;waid=' + nomor + ':+' + nomor + '\n' + 'END:VCARD'
    await samu330.osendMessage(from, { displayname: nama, vcard: vcard }, MessageType.contact)
}

exports.sendMention = async(from, text, mentioned) => {
    await samu330.osendMessage(from, text, MessageType.text, { contextInfo: { mentionedJid: mentioned } })
}

exports.sendImageMention = async(from, buffer, text, mentioned) => {
    await samu330.osendMessage(from, buffer, MessageType.image, { contextInfo: { mentionedJid: [mentioned], participant: [mentioned] }, caption: text })
}
...
exports.sendFakeStatus = async(from, text, mentioned = []) => {
    ...
    await samu330.osendMessage(from, text, MessageType.text, options)
}
...
exports.sendFakeThumb = async(from, buffer, caption = "") => {
    ...
    await samu330.osendMessage(from, buffer, MessageType.image, options)
}
...
exports.hideTag = async(from, text) => {
    ...
    await samu330.osendMessage(from, text, MessageType.text, { contextInfo: { mentionedJid: members } })
}

exports.hideTagImage = async(from, buffer) => {
    members = await this.getGroupParticipants(from)
    await samu330.osendMessage(from, buffer, MessageType.image, { contextInfo: { mentionedJid: members } })
}
                                                                                                                                                                                 
exports.hideTagSticker = async(from, buffer) => {                                                                                                                                    
	members = await this.getGroupParticipants(from)                                                                                                                                  
	await samu330.osendMessage(from, buffer, MessageType.sticker, { contextInfo: { mentionedJid: members } })
}

exports.hideTagContact = async(from, nomor, nama) => {
    let vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:' + nama + '\n' + 'ORG:Kontak\n' + 'TEL;type=CELL;type=VOICE;waid=' + nomor + ':+' + nomor + '\n' + 'END:VCARD'
    members = await this.getGroupParticipants(from)
    await samu330.osendMessage(from, { displayname: nama, vcard: vcard }, MessageType.contact, { contextInfo: { mentionedJid: members } })
}
...
exports.sendKontak = (from, nomor, nama) => {
        const vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:' + nama + '\n' + 'ORG:Kontak\n' + 'TEL;type=CELL;type=VOICE;waid=' + nomor + ':+' + nomor + '\n' + 'END:VCARD'
        samu330.osendMessage(from, {displayname: nama, vcard: vcard}, MessageType.contact)
}
...
exports.kickMember = async(id, target = []) => {
    ...
    for (i of target) {
        if (!i.includes(me) && !i.includes(owner)) {
            ...
            await this.osendMessage(id, "Not Premited!")
            break
        }                                                                                                                                                                            
    }                                                                                                                                                                            
}
...
exports.promoteAdmin = async(to, target = []) => {
    ...
    for (i of target) {
        if (!i.includes(me) && !i.includes(owner)) {
            ...
            await this.osendMessage(to, "Not Premited!")
            break
        }
    }
}
